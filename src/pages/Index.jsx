    ...
    <Modal isOpen={isPreviewOpen} onClose={onPreviewClose}>
      ...
      <ModalContent>
        ...
        <ModalBody>
          ...
          <Text>
            <strong>Logo:</strong> {preview.logo ? preview.logo.name : "No file chosen"}
          </Text>
          <Text>
  ...
  return (
    <>
      ...
      <Container maxW="container.md" py={10}>
        ...
        <Button leftIcon={<FaPaperPlane />} colorScheme="blue" type="button" onClick={handlePreview} mt={4}>
          Preview
        </Button>
        <Button leftIcon={<FaUpload />} colorScheme="teal" type="submit" mt={4}>
          Submit
        </Button>
      </Container>
    </>
